...
class ExceptionHandler:
    ...
    def handler_unknown_error(self):
        ...
        self.level = logging.WARNING
        self.logger.warning(self.exception.__class__.__name__)
    ...
    def handler_gai_error(self):
        self.message = "Failed to connect, try again later..."
        self.status_code = status.HTTP_500_INTERNAL_SERVER_ERROR
        self.exception.add_note(
            "It is possible that the connection parameters to the external service are incorrectly specified"
        )
        self.level = logging.CRITICAL
